...
public class MainMenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switchAlertFlash.setOnCheckedChangeListener((buttonView, isChecked) -> {
            ...
            if (isChecked) {
                // Si no hay permiso de cámara (para linterna) pedirlo
        ...
        // Solicitar permiso de cámara si ya está activada la linterna
        ...
        btnRealtime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainMenuActivity.this, RealtimeMonitoringActivity.class);
        ...
        btnHistoric.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainMenuActivity.this, HistoricDataActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnCharts.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainMenuActivity.this, ChartsActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnAlertas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainMenuActivity.this, AlertHistoryActivity.class);
                startActivity(intent);
            }
        });
        btnConfigIp.setOnClickListener(v -> {
            ...
            MaterialAlertDialogBuilder builder =
                    new MaterialAlertDialogBuilder(MainMenuActivity.this);

            builder.setTitle("IP del servidor MQTT");

            android.widget.LinearLayout layout = new android.widget.LinearLayout(MainMenuActivity.this);
            layout.setOrientation(android.widget.LinearLayout.VERTICAL);
            int padding = (int) (16 * getResources().getDisplayMetrics().density);
            layout.setPadding(padding, padding, padding, padding);

            android.widget.TextView info = new android.widget.TextView(MainMenuActivity.this);
            info.setText(
            ...
            final android.widget.EditText input = new android.widget.EditText(MainMenuActivity.this);
